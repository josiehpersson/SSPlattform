  ...
  return (
    <div>
      ...
      <Modal isOpen={modal} toggle={toggle} className="popup-faktura-container">
        <ModalHeader
          toggle={toggle}
          className="popup-faktura-header">
          <p>{props.fakturanummer || '#102764537'}</p>
          <Boll className="gulboll" zIndex="8" left="177px" top="39px"/>
          <p className="faktura-rubrik">{props.fakturaföretag || 'Teststugan AB'}</p>
          <Boll className="blåboll" width="50px" height="50px" zIndex="10" left="288px" top="45px"/>
       </ModalHeader>
        <ModalBody className="popup-faktura-body">
          ...
          <p>{props.timmar || '40'}h á {props.timpris || '800'}SEK/h</p>
          <p>Summa</p>
